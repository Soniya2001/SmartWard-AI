...
export const DIRECTORY_DATA: Record<string, StateData> = {
  'Tamil Nadu': {
    ...
    cm: {
      ...
      role: 'Chief Minister',
      category: 'cm',
      photo: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Vijay&radius=50&backgroundColor=c084fc',
      state: 'Tamil Nadu',
      ...
      biography: 'Thiru. C. Joseph Vijay is a visionary leader and the current Chief Minister of Tamil Nadu, heading the new-age democratic government focused on systemic anti-corruption, youth empowerment, digital-first municipal ward integration, and secular social justice.',
      responsibilities: [
    ...
    ministers: [
      {
        id: 'TN-MIN-1',
        name: 'Thiru. Bussy N. Anand',
        role: 'Minister for Municipal Administration & Water Supply',
        category: 'minister',
        ministry: 'Municipal Administration',
        photo: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Anand&radius=50&backgroundColor=ffe0cc',
        email: 'min.maws@tn.gov.in',
        phone: '+91 44 2567 2201',
        officeAddress: 'Secretariat Building, Fort St. George, Chennai - 600009',
        biography: 'Thiru. Bussy N. Anand is a key organizer and senior cabinet minister driving urban municipal transformation, local self-governance platforms, and clean water delivery mechanisms across Tamil Nadu.',
        responsibilities: [
    ...
    districts: {
      'Madurai': {
        ...
        collector: {
          id: 'MDU-COLL',
          name: 'Dr. M. S. Sangeetha, IAS',
          role: 'District Collector & District Magistrate',
          category: 'collector',
          photo: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Sangeetha&radius=50&backgroundColor=ffd1d1',
          ...
          district: 'Madurai',
          biography: 'Dr. M. S. Sangeetha, IAS, is a highly decorated administrative officer leading Madurai district. She monitors revenue administration, coordinates welfare schemes, and conducts weekly public grievance check-ins.',
          responsibilities: [
        ...
        commissioner: {
          id: 'MDU-COMM',
          name: 'Thiru L. Madhubalan, IAS',
          role: 'Municipal Commissioner',
          category: 'commissioner',
          photo: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Madhubalan&radius=50&backgroundColor=d1ffd1',
          ...
          biography: 'Thiru L. Madhubalan, IAS, administers the Madurai City Municipal Corporation. He is known for fast-tracking storm water drain projects and digitized waste disposal tracking systems.',
          responsibilities: [
        ...
        mlas: [
          {
            id: 'MDU-MLA-1',
            name: 'Thiru Sellur K. Raju',
            role: 'Member of Legislative Assembly (MLA)',
            category: 'mla',
            constituency: 'Madurai West',
            photo: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Sellur&radius=50&backgroundColor=e1f5fe',
            email: 'sellur.raju@tnmla.gov.in',
            phone: '+91 94444 12345',
            officeAddress: 'Madurai West MLA Office, Palanganatham, Madurai',
            performanceBadge: 'Highly Responsive',
            biography: 'Thiru Sellur K. Raju has served as an MLA for multiple terms, heavily focusing on drinking water supply and neighborhood road connectivity inside Madurai West.',
            responsibilities: [
          ...
          {
            id: 'MDU-MLA-2',
            name: 'Thiru G. Thalapathi',
            role: 'Member of Legislative Assembly (MLA)',
            category: 'mla',
            constituency: 'Madurai North',
            photo: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Thalapathi&radius=50&backgroundColor=f3e5f5',
            email: 'thalapathi.g@tnmla.gov.in',
            phone: '+91 94444 54321',
            officeAddress: 'Madurai North MLA Office, Bibikulam, Madurai',
            performanceBadge: 'SLA Champion',
            biography: 'Thiru G. Thalapathi is dedicated to urban health clinic upgrades, smart public parks, and primary school infrastructure restorations inside Madurai North.',
            responsibilities: [
          ...
          {
            id: 'MDU-MLA-3',
            name: 'Thiru Dr. P. Saravanan',
            role: 'Member of Legislative Assembly (MLA)',
            category: 'mla',
            constituency: 'Madurai South',
            photo: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Saravanan&radius=50&backgroundColor=fff3e0',
            email: 'saravanan.p@tnmla.gov.in',
            phone: '+91 94444 98765',
            officeAddress: 'Madurai South MLA Office, Villapuram, Madurai',
            performanceBadge: 'Community Builder',
            biography: 'Dr. P. Saravanan combines medical expertise with civic administration to improve community clinics, drainage conduits, and garbage management systems.',
            responsibilities: [
      ...
      'Coimbatore': {
        ...
        collector: {
          id: 'CBE-COLL',
          name: 'Thiru Kranthi Kumar Pati, IAS',
          role: 'District Collector & District Magistrate',
          category: 'collector',
          photo: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Kranthi&radius=50&backgroundColor=d1ffd1',
          ...
          district: 'Coimbatore',
          biography: 'Thiru Kranthi Kumar Pati, IAS, is the executive head of Coimbatore District. He focuses heavily on industrial zone infrastructure, bypass lanes expansion, and water basin preservation schemes.',
          responsibilities: [
        ...
        commissioner: {
          id: 'CBE-COMM',
          name: 'Thiru M. Sivaguru Prabakaran, IAS',
          role: 'Municipal Commissioner',
          category: 'commissioner',
          photo: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Prabakaran&radius=50&backgroundColor=ffebee',
          ...
          biography: 'Thiru M. Sivaguru Prabakaran, IAS, runs municipal assets, drinking water schemes, and smart industrial road grids across Coimbatore City limits.',
          responsibilities: [
        ...
        mlas: [
          {
            id: 'CBE-MLA-1',
            name: 'Thiru Amman K. Arjunan',
            role: 'Member of Legislative Assembly (MLA)',
            category: 'mla',
            constituency: 'Coimbatore South',
            photo: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Arjunan&radius=50&backgroundColor=f3e5f5',
            email: 'arjunan.a@tnmla.gov.in',
            phone: '+91 94444 22001',
            officeAddress: 'Amman MLA Office, Race Course, Coimbatore',
            performanceBadge: 'Infrastructure Champion',
            biography: 'Thiru Amman K. Arjunan is known for his focused efforts in modernizing local text-tile industrial pockets and bringing advanced underground sewerage to urban grids.',
            responsibilities: [
          ...
          },
          {
            ...
            photo: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Vanathi&radius=50&backgroundColor=ffe0cc',
            email: 'vanathi.s@tnmla.gov.in',
            phone: '+91 94444 22002',
            officeAddress: 'Vanathi MLA Office, Gandhipuram, Coimbatore',
            performanceBadge: 'Community Liaison',
            biography: 'Smt. Vanathi Srinivasan focuses heavily on women self-help empowerment guilds, park security installations, and citizen literacy campaigns.',
            responsibilities: [
          ...
          {
            id: 'CBE-MLA-3',
            name: 'Thiru PRG Arunkumar',
            role: 'Member of Legislative Assembly (MLA)',
            category: 'mla',
            constituency: 'Coimbatore North',
            photo: 'https://api.dicebear.com/7.x/avataaars/svg?seed=PRG&radius=50&backgroundColor=e1f5fe',
            email: 'arunkumar.prg@tnmla.gov.in',
            phone: '+91 94444 22003',
            officeAddress: 'PRG MLA Office, Kavundampalayam, Coimbatore',
            performanceBadge: 'SLA Pioneer',
            biography: 'Thiru PRG Arunkumar has consistently targeted flyover bottleneck issues, water main links, and smart streetlight coverage on the ring-roads.',
            responsibilities: [
  ...
  'Karnataka': {
    ...
    cm: {
      ...
      role: 'Chief Minister',
      category: 'cm',
      photo: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Siddaramaiah&radius=50&backgroundColor=e1f5fe',
      state: 'Karnataka',
      ...
      biography: 'Shri Siddaramaiah is an esteemed Indian politician serving as the 24th Chief Minister of Karnataka. He has implemented large-scale public transportation schemes, direct-benefit financial transfers, and digital civic governance interfaces.',
      responsibilities: [
    ...
    ministers: [
      {
        ...
        category: 'minister',
        ministry: 'Municipal Administration',
        photo: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Shivakumar&radius=50&backgroundColor=d1ffd1',
        email: 'dycm.blr@karnataka.gov.in',
        phone: '+91 80 2225 2201',
        officeAddress: 'Vidhana Soudha, Bengaluru - 560001',
        biography: 'Shri D. K. Shivakumar coordinates urban infrastructure development, metropolitan drinking water supply (BWSSB), and BBMP operations.',
        responsibilities: [
      ...
      },
      {
        ...
        category: 'minister',
        ministry: 'Public Works (PWD)',
        photo: 'https://api.dicebear.com/7.x/avataaars/svg?seed=HKPatil&radius=50&backgroundColor=f3e5f5',
        email: 'min.law@karnataka.gov.in',
        phone: '+91 80 2225 2202',
        officeAddress: 'Vidhana Soudha, Bengaluru - 560001',
        biography: 'Shri H. K. Patil monitors parliamentary regulations, state legal frameworks, PWD alignments, and judicial audits.',
        responsibilities: [
      ...
      },
      {
        ...
        category: 'minister',
        ministry: 'Health',
        photo: 'https://api.dicebear.com/7.x/avataaars/svg?seed=GunduRao&radius=50&backgroundColor=fff3e0',
        email: 'min.health@karnataka.gov.in',
        phone: '+91 80 2225 2203',
        officeAddress: 'Vidhana Soudha, Bengaluru - 560001',
        biography: 'Shri Dinesh Gundu Rao directs public health grids, expansion of "Namma Clinics", immunization plans, and municipal sanitation inspections.',
        responsibilities: [
      ...
      {
        id: 'KA-MIN-4',
        name: 'Shri Madhu Bangarappa',
        role: 'Minister for Primary & Secondary Education',
        category: 'minister',
        ministry: 'Education',
        photo: 'https://api.dicebear.com/7.x/avataaars/svg?seed=MadhuB&radius=50&backgroundColor=ffebee',
        email: 'min.edu@karnataka.gov.in',
        phone: '+91 80 2225 2204',
        officeAddress: 'Vidhana Soudha, Bengaluru - 560001',
        biography: 'Shri Madhu Bangarappa drives curriculum modernizations, smart classrooms integration, and building safety certifications across state school systems.',
        responsibilities: [
    ...
    districts: {
      'Bengaluru Urban': {
        ...
        collector: {
          id: 'BLR-COLL',
          name: 'Shri K. A. Dayanand, IAS',
          role: 'District Collector & District Magistrate',
          category: 'collector',
          photo: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Dayanand&radius=50&backgroundColor=e8f5e9',
          ...
          biography: 'Shri K. A. Dayanand is an IAS officer heading Bengaluru Urban. He has pioneered direct digital title deeds and weekly public revenue grievance resolution days.',
          responsibilities: [
        ...
        commissioner: {
          ...
          category: 'commissioner',
          photo: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Tushar&radius=50&backgroundColor=e3f2fd',
          ...
          biography: 'Shri Tushar Giri Nath, IAS, runs the massive Bruhat Bengaluru Mahanagara Palike. He is active in modern waste processing setups, smart flyover construction, and resolving pothole complaints via GIS tracing.',
          responsibilities: [
        ...
        mlas: [
          {
            ...
            photo: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Ashoka&radius=50&backgroundColor=ffebee',
            email: 'ashoka.r@karnatakala.gov.in',
            phone: '+91 94480 12345',
            officeAddress: 'Padmanabhanagar MLA Office, Banashankari, Bengaluru',
            performanceBadge: 'Infrastructure Builder',
            biography: 'Shri R. Ashoka has represented Padmanabhanagar for several terms, driving advanced drinking water main lines and robust flyover loops.',
            responsibilities: [
          ...
          {
            id: 'BLR-MLA-2',
            name: 'Shri B. Z. Zameer Ahmed Khan',
            role: 'Member of Legislative Assembly (MLA)',
            category: 'mla',
            constituency: 'Chamarajpet',
            photo: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Zameer&radius=50&backgroundColor=fff3e0',
            email: 'zameer.khan@karnatakala.gov.in',
            phone: '+91 94480 54321',
            officeAddress: 'Chamarajpet MLA Office, Mysore Road, Bengaluru',
            performanceBadge: 'Highly Accessible',
            biography: 'Shri B. Z. Zameer Ahmed Khan focuses on urban housing redevelopment plans, maternal clinic support, and central drainage clearing schedules.',
            responsibilities: [
          ...
          {
            id: 'BLR-MLA-3',
            name: 'Shri S. Suresh Kumar',
            role: 'Member of Legislative Assembly (MLA)',
            category: 'mla',
            constituency: 'Rajajinagar',
            photo: 'https://api.dicebear.com/7.x/avataaars/svg?seed=SureshK&radius=50&backgroundColor=e8f5e9',
            email: 'sureshkumar.s@karnatakala.gov.in',
            phone: '+91 94480 98765',
            officeAddress: 'Rajajinagar MLA Office, Rajajinagar, Bengaluru',
            performanceBadge: 'SLA Champion',
            biography: 'Shri S. Suresh Kumar is highly regarded for clean school infrastructure transformations and transparency in municipal fund disbursements.',
            responsibilities: [
